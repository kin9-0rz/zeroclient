...
.. code-block:: json
    ...
    Request:
    {
        ...
        "params":
        <JSON object containing the argumets to the method>
        <JSON array containing the arguments to the method>
    }
...
这个协议不做变化，关键在params这里，method表示rpc对应的操作，操作的内容自然是params了。
"""
...
_SOCKET_READ_TIMEOUT = 5  # callback_handler.MAX_TIMEOUT
